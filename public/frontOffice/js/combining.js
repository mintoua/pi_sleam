                                ...
                                n &&
                                    ((n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null),
                                        ...
                                        o(
                                            ...
                                            'string' != typeof s.responseText ? { binary: s.response } : { text: s.responseText },
...
(function(
    ...
    function r(e) {
        ...
        for (
            var o = ie(10) ? document.body : null, n = e.offsetParent; n === o && e.nextElementSibling;
    ...
    function Y(e, t) {
        Object.keys(t).forEach(function(o) {
            var n = ''; - 1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) &&
                U(t[o]) &&
                (n = 'px'),
                (e.style[o] = t[o] + n)
        })
                            ...
                            if ((l._clearMenus(), !e)) {
                                ...
                                if ((mt(t).trigger(i), !i.isDefaultPrevented())) {
                                    if (!this._inNavbar) {
                                        ...
                                        var r = this._element 'parent' === this._config.reference ?
                                            (r = t) :
            ...
            (se = (function() {
                ...
                return (
                    ...
                    (t._adjustDialog = function() {
                        var t =
                            this._element.scrollHeight > document.documentElement.clientHeight!this._isBodyOverflowing &&
                            t &&
            ...
            (Se = (function() {
                ...
                return (
                    ...
                    (t.setElementContent = function(t, e) {
                        var n = this.config.html 'object' == typeof e && (e.nodeType || e.jquery) ?
                            n ?
    ...
    !(function(a) {
        ...
        (e.prototype = {
            ...
            setStyle: function(a, b) {
                ...
                var c = a ? a : this.options.style 'add' == b ?
                ...
                this.isDisabled() ?
                    ...
                    (this.$button.hasClass('disabled') &&
                        (this.$newElement.removeClass('disabled'),
                            this.$button.removeClass('disabled')), -1 != this.$button.attr('tabindex') ||
            ...
            clickListener: function() {
                ...
                this.$newElement.on(
                    ...
                    this.$menu.on('click', 'li a', function(c) {
                        ...
                        if (
                            (b.multiple && c.stopPropagation(),
                                c.preventDefault(), !b.isDisabled() && !d.parent().hasClass('disabled'))
                        ) {
                    ...
                    this.$menu.on('click', 'li.divider, li.dropdown-header', function(
                        a,
                    ) {
                        a.preventDefault(),
                            a.stopPropagation(),
            ...
            keydown: function(c) {
                ...
                if (
                    (o.options.liveSearch && (n = m.parent().parent()),
                        ...
                        (l = o.$menu.parent().hasClass('open')), !l &&
                    ...
                    if (/(38|40)/.test(c.keyCode.toString(10)))
                        ...
                        (o.options.liveSearch && (e -= 1),
                            ...
                            e == k && (e = h)) :
                        40 == c.keyCode &&
                        (o.options.liveSearch && (e += 1), -1 == e && (e = 0),
                            e != j && f > e && (e = f),
                            e > h && (e = h),
                            e == k && (e = g)),
                        m.data('prevIndex', e),
    ...
    (function(e, t) {
        ...
        (s.prototype.getImages = function() {
            ...
            for (var e = 0, t = this.elements.length; t > e; e++) {
                ...
                for (
                    var i = n.querySelectorAll('img'), r = 0, o = i.length; o > r; r++
                ) {
                    var s = i[r]
                    this.addImage(s)
                }
...
!(function(t) {
    ...
    var n = Array.prototype.slice 'function' == typeof define && define.amd ?
...
function() {
    ...
    (function(t) {
        ...
        var i = 'Webkit Moz ms Ms O'.split(' '),
            n = document.documentElement.style 'function' == typeof define && define.amd ?
    ...
    (function(t, e) {
        ...
        if (a) {
            var h = document.createElement('div'),
                p = i(h, 'div')
            s = p ? i : r
        } else s = o 'function' == typeof define && define.amd ?
        ...
        function s(i, s, f, d, l, m) {
            ...
            return (
                ...
                (y.prototype._filterFindItemElements = function(t) {
                    t = n(t)
                    for (
                        var e = this.options.itemSelector, i = [], o = 0, r = t.length; r > o; o++
                    ) {
                        var s = t[o]
                        if (c(s))
                            if (e) {
                                l(s, e) && i.push(s)
                                for (
                                    var a = s.querySelectorAll(e), h = 0, p = a.length; p > h; h++
                                )
                                    i.push(a[h])
                            } else i.push(s)
                    }
...
(function(a, b, c, d) {
    ...
    (e.prototype.thumbnail = function(b, c) {
        ...
        if (
            ...
            return l(h.attr(i)), h.remove(), !1 'youtube' === c.type ?
    ...
    var e = $(window).width(),
        ...
        a = function() {
            ...
            jQuery('.dzseth > div, .dzseth .img-cover, .dzseth .seth').each(function(
                ...
                jQuery('.dzseth > div, .dzseth .img-cover, .dzseth .seth').each(
                    function(e) {
                ...
                jQuery('.box-hover').on('mouseenter', function() {
                        ...
                        jQuery(window).on('scroll', function() {
                            if (jQuery('.sticky-header').length > 0) {
                                ...
                                $(window).scrollTop() > e.offset().top ?
                                    (e.addClass('is-fixed'),
                                        $('.header-style-5 .container > .logo-header .logo').attr(
                                            'src',
                                            'images/logo.png',
                                        )) :
                    ...
                    jQuery('.gallery-filter.masonary').on('click', 'span', function() {
                        ...
                        return (
                            ...
                            jQuery('#image-gallery-isotope').isotope({ filter: e }), !1
                        )
                    }),
                    (function(e) {
                        $('.countdown').length &&
...
function contactForm() {
    ...
    $('.dzForm').on('submit', function(t) {
            ...
            $.ajax({
                ...
                success: function(t) {
                    1 == t.status &&
                        (e = '<div class="gen alert alert-success">' + t.msg + '</div>'),
                        0 == t.status &&
                        (e = '<div class="err alert alert-danger">' + t.msg + '</div>'),
                        $('.dzFormMsg').html(e),
                        $('.dzForm')[0].reset(),
                        grecaptcha.reset()
                },
            ...
            $.ajax({
                ...
                success: function(t) {
                    1 == t.status && (e = '<p style="color: #34A853">' + t.msg + '</p>'),
                        0 == t.status &&
                        (e = '<p style="color: #EA4335">' + t.msg + '</p>'),
        ...
        addSwitcher(),
            ...
            jQuery('.skin-1').on('click', function() {
                return (
                    ...
                    jQuery('.logo-header img').attr('src', 'images/logo.png'), !1
                )
            }),
            jQuery('.skin-2').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-2.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo2.png'), !1
                )
            }),
            jQuery('.skin-3').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-3.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo3.png'), !1
                )
            }),
            jQuery('.skin-4').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-4.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo4.png'), !1
                )
            }),
            jQuery('.skin-5').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-5.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo5.png'), !1
                )
            }),
            jQuery('.skin-6').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-6.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo6.png'), !1
                )
            }),
            jQuery('.skin-7').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-7.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo7.png'), !1
                )
            }),
            jQuery('.skin-8').on('click', function() {
                return (
                    jQuery('.skin').attr('href', 'css/skin/skin-8.css'),
                    jQuery('.logo-header img').attr('src', 'images/logo8.png'), !1
                )
            }),
